...
class ChangeManagerLocators:
    ...
    MANAGER_GROUP_BTN = (
        By.XPATH,
        "//div[@id='WIN_3_1000000015']//a[@class='btn btn3d menu']",
    )
    IMPLEMENTATION_MENU = (
        By.XPATH,
        "//div[@class='MenuOuter']//div[@class='MenuTableContainer']//table[@class='MenuTable']"
    ...
    TX_OPTIMIZATION_SELECT_BTN = (
        By.XPATH,
        "//td[contains(text(),'Access Network Rollout_2(3G)')]",
    )
    RADIO_ROLLOUT_SELECT_BTN = (
        By.XPATH,
        "//td[contains(text(),'Access Network Rollout_2(3G)')]",
    )
    ...
    CHANGE_MANAGER_SHAHED = (
        By.XPATH,
        "//div[@class='MenuOuter']//*[text()='Muhammad Shahed']",
    )
    CHANGE_MANAGER_RIPAN = (
        By.XPATH,
        "//div[@class='MenuOuter']//*[text()='Ripan Kumar']",
    )
    CHANGE_MANAGER_FUAD = (
        By.XPATH,
        "//div[@class='MenuOuter']//*[text()='Faisal Mahmud Fuad']",
    )
    CHANGE_MANAGER_MUSFIQ = (
        By.XPATH,
        "//div[@class='MenuOuter']//*[text()= 'Md. Musfiqur  Rahman']",
    )
    CHANGE_MANAGER_SHAHRIAR = (
        By.XPATH,
        "//div[@class='MenuOuter']//*[text()='Shahriar Mahbub']",
    )
    CHANGE_MANAGER_SUMON = (
        By.XPATH,
        "//div[@class='MenuOuter']//*[text()='Sumon Kumar Biswas']",
    )
    CHANGE_MANAGER_RAKIB = (
        By.XPATH,
        "//div[@class='MenuOuter']//*[text()='Md. Rakibuzzaman']",
    )
    CHANGE_MANAGER_KHAIRUL = (
        By.XPATH,
        "//div[@class='MenuOuter']//*[text()='K.M Khairul Bashar']",
    )
    CHANGE_MANAGER_SUDIPTA = (
        By.XPATH,
        "//div[@class='MenuOuter']//*[text()='Sudipta Das']",
    )
    CHANGE_MANAGER_FATEMA = (
        By.XPATH,
        "//div[@class='MenuOuter']//*[text()='Fatema Binte Ahmed']",
    )
...
class TaskSectionLocators:
    ...
    TASK_GROUP_TEMPLATE_BTN = (
        By.XPATH,
        "//td[contains(text(), 'Task Group Template')]",
    )
    ...
    INITIATION_TASK_SPAN = (
        By.XPATH,
        "//span[contains(text(), 'Initiation Phase Task (SOC)')]",
    )

    # ==> DOWNTIME DURATION PAGE LOCATORS <== #
    SERVICE_DOWNTIME_DURATION_TASK_SPAN = (
        By.XPATH,
        "//span[contains(text(), 'Service Downtime Duration Task')]",
    )

    # ==> SYSTEM  DOWNTIME TASK LOCATORS <== #
    SYSTEM_DOWNTIME_TASK = (
        By.XPATH,
        "//span[contains(text(), 'System Downtime Task')]",
    )

    # ==> DOWNTIME WINDOW PAGE LOCATORS <== #
    SERVICE_DOWNTIME_WINDOW_TASK_SPAN = (
        By.XPATH,
        "//span[contains(text(), 'Service Downtime Window Task')]",
    )

    # ==> REVIEW & CLOSE TASK PAGE LOCATORS <== #
    REVIEW_CLOSURE_TASK_SPAN = (
        By.XPATH,
        "//span[contains(text(), 'Review and Closure Task (SOC)')]",
    )
...
class WorkInfoAttachment:
    ...
    INFO_NOTES_TEXTBOX = (
        By.XPATH,
        "//div[@id='WIN_3_304247080']//*[@id='arid_WIN_3_304247080']",
    )
    ATTACH_FILE_ICON_BUTTON = (By.XPATH, "//img[@id='reg_img_304247100']")
    UPLOAD_ATTACHMENT_FRAME = (
        By.XPATH,
        "//iframe[@src='http://itsm-web.robi.com.bd:8080/arsys/resources/html/AttachmentPopup.html']",
    )
    CHOOSE_ATTACHMENT_FRAME = (By.XPATH, "//input[@id='PopupAttInput']")
    OK_ATTACHMENT_FRAME_BUTTON = (
        By.XPATH,
        "//div[@id='PopupAttFooter']/a[contains(text(), 'OK')]",
    )
    ADD_NOTE_ATTACHMENT_BUTTON = (
        By.XPATH,
        "//a[@id='WIN_3_304247110']//div[@class='f1'][contains(text(),'Add')]",
    )
    MORE_DETAILS_BUTTON = (
        By.XPATH,
        "//div[@id='WIN_3_304247070']//a[@class='pagebtn ']",
    )
...
class CommonChangeCreateLocators:
    ...
    CHANGE_NUMBER_VALUE = (
        By.XPATH,
        "//div[@id='WIN_3_1000000182']//textarea[@id='arid_WIN_3_1000000182']",
    )
...
class SaveChangeLocators:
    ...
    GOTO_NEXT_STAGE_BTN = (
        By.XPATH,
        "//div[@class='f7'][contains(text(), 'Next Stage')]",
    )
...
class FrameBoxLocators:
    ...
    FRAME_OF_CONFIRMATION = (
        By.XPATH,
        "//iframe[@src='http://itsm-web.robi.com.bd:8080/arsys/resources/html/MessagePopup.html']",
    )
    FRAME_OK_BUTTON = (
        By.XPATH,
        "//div[@id='PopupMsgFooter']//a[contains(text(),'OK')]",
    )
...
class CloseChangeLocators:
    ...
    SELECT_CLOSE = (
        By.XPATH,
        "//tr[@class='MenuTableRow']//td[contains(text(), 'Closed')]",
    )
...
class RelationshipQueryLocators:
    ...
    RELATIONSHIP_TAB_BTN = (
        By.XPATH,
        "//a[@class='btn f1'][contains(text(), 'Relationships')]",
    )
    ...
    RELATIONSHIP_ADVANCE_SEARCH_LINK = (
        By.XPATH,
        "//div[contains(text(),'Use Advanced Search')]",
    )
    RELATIONSHIP_QUERY_TEXTBOX = (By.XPATH, "//textarea[@id='arid_WIN_0_304328790']")

    RELATIONSHIP_ADVANCE_SEARCH_BTN = (
        By.XPATH,
        "//a[@id='WIN_0_301867800']//div[@class='f1'][contains(text(),'Search')]",
    )

    RELATIONSHIP_ROBI_AXIATA = (By.XPATH, "//*[contains(text(), 'Robi-Axiata')]")

    RELATE_THE_RELATIONSHIP_BTN = (
        By.XPATH,
        "//a[@id='WIN_0_301867500']//div[@class='f1']",
    )
