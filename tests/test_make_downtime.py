...
def test_downtime_1():
    ...
    date = make_downtime_from_open_time_2(
        _open_time, "6/6/2021 11:00:00 AM", "6/6/2021 11:45:00 AM"
    )
    _cal_date = datetime.strptime(date, FORMAT)
...
def test_downtime_2():
    ...
    date = make_downtime_from_open_time_2(
        _open_time, "6/6/2021 11:00:00 AM", "6/6/2021 2:00:00 PM"
    )
    _cal_date = datetime.strptime(date, FORMAT)
    _start_date = datetime.strptime(_open_time, FORMAT)
